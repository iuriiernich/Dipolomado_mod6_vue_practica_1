        ...
        <div>
            <div class="mb-3">
                <div class="input-group">
                    <span class="input-group-text" id="name-filter"><i class="bi bi-filter"></i> Filtrar por
                        Nombre</span>
            ...
            <div class="mb-3">
                <div class="input-group">
                    <span class="input-group-text" id="email-search-text"><i class="bi bi-search"></i> Buscar por
                        Email</span>
